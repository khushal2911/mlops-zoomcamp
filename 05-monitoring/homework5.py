...
def calculate_metrics_postgresql(curr, i):
	...
	median_fare_amount = result['metrics'][1]['result']['current']['value']
	...
	curr.execute(
		"insert into dummy_metrics(timestamp, prediction_drift, median_fare_amount, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s, %s)",
		(begin + datetime.timedelta(i), prediction_drift, median_fare_amount, num_drifted_columns, share_missing_values)
	)
