...
Tip: go to `02-experiment-tracking/homework/` folder before executing the command and change the value of `<TAXI_DATA_FOLDER>` to the location where you saved the data. // I ran the above script from notebooks folder and then moved output dir to 02-exp-track/homework/
